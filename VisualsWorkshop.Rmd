...
#### Lots of support
R is very popular and there is a lot of support online, both in the form of packages and documentation and in places like StachOverflow where people help address questions and problems people are facing.
...
library(magick)
freqcombo<- image_read("Freq.combo.example.png")
freqcombo

baskets<- image_read("ComboBasketsExample.png")
baskets

salmon.milk<-image_read("Salmon.Milk.Example.png")
salmon.milk

caloricneeds<- image_read("CaloricNeeds.png")
caloricneeds

HFIAS<- image_read("HFIASFitted.png")
HFIAS
```
