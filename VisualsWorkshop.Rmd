...
#### Reproducible
This is probably the biggest selling point of R for me. Of the different programs I have used to create plots, R is by far the most straightforward for updating the plots as new data becomes available, as collaborators ask for changes, or as is often the case for me when you walk away from a project for some time and need to remember what actually is going on. This also makes it easier to share plots and have others contribute to them in a way that you can track.

#### All in one place
Another stength is that you can work with and clean your data, run statistical tests and models, and generate very compelling and customizable plots all in one place. And you have a record of all of that. 
